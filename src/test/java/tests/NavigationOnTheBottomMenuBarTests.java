...
public class NavigationOnTheBottomMenuBarTests extends BaseMobileTest {
  ...
  public void navigateToDragScreen()  {
    DragScreen dragSection = (DragScreen) CommonActions.clickOnMenuOption("Drag");
  ...
  public void navigateToFormsScreen(){
    FormsScreen formsSection = (FormsScreen) CommonActions.clickOnMenuOption("Forms");
  ...
  public void navigateWebviewScreen(){
    WebviewScreen webviewScreen = (WebviewScreen) CommonActions.clickOnMenuOption("Webview");
  ...
  public void navigateToHomeScreen()  {
    HomeScreen homeScreen = (HomeScreen) CommonActions.clickOnMenuOption("Home");
